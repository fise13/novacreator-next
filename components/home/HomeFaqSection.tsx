  ...
  return (
    <section id="faq" className="px-3 py-14 text-black dark:text-white sm:px-4 sm:py-20">
      <div className="mx-auto max-w-7xl">
        <p className="text-sm font-semibold uppercase tracking-[0.28em] text-[#ff5a45]">{content.faq.eyebrow}</p>
        <h2 className="mt-4 max-w-4xl font-radio text-4xl font-black leading-[0.98] tracking-[-0.07em] sm:text-6xl">
          {content.faq.title}
        </h2>
        <p className="mt-4 max-w-2xl text-base font-medium leading-7 text-black/60 dark:text-white/90">
          {content.faq.subtitle}
        </p>
        <div className="mt-8 divide-y divide-black/10 rounded-[1.5rem] border border-black/10 bg-white/75 dark:divide-white/10 dark:border-white/12 dark:bg-[#171a22]">
